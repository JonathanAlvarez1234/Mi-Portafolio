  ...
  vec3 getNormal(vec3 pos) {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const fadeStart = 0;   // Empieza a desvanecer desde el top
            const fadeEnd = 200;   // Desaparece completamente a los 200px (ajusta a gusto)

            const newOpacity = scrollTop < fadeEnd
                ? 1 - scrollTop / fadeEnd
                : 0;
    ...
    return (
        <CanvasWrapper>
            ...
            <Html center>
                <div
                    className="beam-title-container"
